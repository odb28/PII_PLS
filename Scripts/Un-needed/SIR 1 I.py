if __name__ == '__main__':
    ...
    np.savetxt(f"../Data/Traj_fixed_g_{seed}_N_{sum(X0)}_I1_b_{beta}.csv", b1, delimiter=",")
    ...
    np.savetxt(f"../Data/Traj_fixed_g_{seed}_N_{sum(X0)}_I1_b_{beta}.csv", b2, delimiter=",")
    ...
    np.savetxt(f"../Data/Traj_fixed_g_{seed}_N_{sum(X0)}_I1_b_{beta}.csv", b3, delimiter=",")