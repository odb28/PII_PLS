...
#%%
for i in range(1,11):
    b_10 = np.ndarray.flatten(np.genfromtxt(f"../Data/Traj_{i}_N_10_no_ext_b.csv", delimiter= ","))
    b_100 = np.ndarray.flatten(np.genfromtxt(f"../Data/Traj_{i}_N_100_no_ext_b.csv", delimiter= ","))
    b_1000 = np.ndarray.flatten(np.genfromtxt(f"../Data/Traj_{i}_N_1000_no_ext_b.csv", delimiter= ","))
    g_10 = np.ndarray.flatten(np.genfromtxt(f"../Data/Traj_{i}_N_10_no_ext_g.csv", delimiter= ","))
    g_100 = np.ndarray.flatten(np.genfromtxt(f"../Data/Traj_{i}_N_100_no_ext_g.csv", delimiter= ","))
    g_1000 = np.ndarray.flatten(np.genfromtxt(f"../Data/Traj_{i}_N_1000_no_ext_g.csv", delimiter= ","))
