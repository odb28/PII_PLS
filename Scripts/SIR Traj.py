if __name__ == '__main__':
    ...
    np.savetxt(f"../Data/Traj_{seed}_N_{sum(X0)}_b.csv", b1, delimiter=",")
    np.savetxt(f"../Data/Traj_{seed}_N_{sum(X0)}_g.csv", g1, delimiter=",")
    ...
    np.savetxt(f"../Data/Traj_{seed}_N_{sum(X0)}_b.csv", b2, delimiter=",")
    np.savetxt(f"../Data/Traj_{seed}_N_{sum(X0)}_g.csv", g2, delimiter=",")
    ...
    np.savetxt(f"../Data/Traj_{seed}_N_{sum(X0)}_b.csv", b3, delimiter=",")
    np.savetxt(f"../Data/Traj_{seed}_N_{sum(X0)}_g.csv", g3, delimiter=",")