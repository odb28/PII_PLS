...
def sim_sir_fixed(b,model_rng):
    return meta_no_ext_sir(X0,b,gamma,N,test_distances,basic_kernel,tmax,tstep,model_rng) * factor
N = 4
...
np.savetxt(f"../fittings/fit1000s/Traj_meta_{seed}_{iteration}_1000b_noext.csv",applied_ABC1,delimiter=",")
