...
if iteration == 1:
    betas = np.arange(10,10.51,0.01)
elif iteration == 2:
    betas = np.arange(10.51, 11.01, 0.01)
elif iteration == 3:
    betas = np.arange(11.01, 11.51, 0.01)
elif iteration == 4:
    betas = np.arange(11.51, 12.01, 0.01)
#elif iteration == 5:
...
np.savetxt(f"../fittings/fit10s/Traj_{seed}_{iteration+18}_10b{I0}.csv",applied_ABC3,delimiter=",")
